...
const backgrounds = [
  {
    ...
    label: "Soft Florals",
    icon: "🌸",
    css: "url('/wp-content/uploads/2026/base-options/soft-floral-life-story-base.jpg')",
    image: null,
    paperBg: "#fdf6f0",
  },
  {
    ...
    label: "Autumn Leaves",
    icon: "🍂",
    css: "url('/wp-content/uploads/2026/base-options/autumn-leaves-life-story-base.jpg')",
    image: null,
    paperBg: "#fdf8f2",
  },
  {
    ...
    label: "Ocean & Coast",
    icon: "🌊",
    css: "url('/wp-content/uploads/2026/base-options/ocean-Coast-life-story-base.jpg')",
    image: null,
    paperBg: "#f4fafc",
  },
  {
    ...
    label: "Faith & Grace",
    icon: "✝️",
    css: "url('/wp-content/uploads/2026/base-options/faith-and-Grace-life-story-base.jpg')"
    image: null,
    paperBg: "#faf7f2",
  },
  {
    ...
    icon: "🎖️",
    css: "url('/wp-content/uploads/2026/base-options/military-honor-life-story-base.jpg')",
    image: null,
    paperBg: "#f4f7fa",
  },
  {
    ...
    label: "Garden & Nature",
    icon: "🌿",
    css: "url('/wp-content/uploads/2026/base-options/garden-nature-life-story-base.jpg')",
    image: null,
    paperBg: "#f4faf2",
  },
  {
    ...
    label: "Elegant Linen",
    icon: "🕊️",
    css: "url('/wp-content/uploads/2026/base-options/elegant-linen-life-story-base.jpg')",
    image: null,
    paperBg: "#faf9f7",
  },
  {
    ...
    label: "Golden Sunset",
    icon: "🌅",
    css: "url('/wp-content/uploads/2026/base-options/golden-sunset-life-story-base.jpg')",
    image: null,
    paperBg: "#fdf8f0",
  },
  {
    ...
    icon: "📜",
    css: "url('/wp-content/uploads/2026/base-options/vintage-script-life-story-base.jpg')",
    image: null,
    paperBg: "#faf7ef",
  },
  {
    ...
    label: "Candlelight",
    icon: "🕯️",
    css: "url('/wp-content/uploads/2026/base-options/candles-life-story-base.jpg')",
    image: null,
    paperBg: "#fdfaf4",
  },
];
