...
const backgrounds = [
  {
    ...
    label: "Soft Florals",
    icon: "🌸",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/soft-floral-life-story-base.jpg')",
    image: null,
    paperBg: "#fdf6f0",
  },
  {
    ...
    label: "Autumn Leaves",
    icon: "🍂",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/autumn-leaves-life-story-base.jpg')",
    image: null,
    paperBg: "#fdf8f2",
  },
  {
    ...
    label: "Ocean & Coast",
    icon: "🌊",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/ocean-Coast-life-story-base.jpg')",
    image: null,
    paperBg: "#f4fafc",
  },
  {
    ...
    label: "Faith & Grace",
    icon: "✝️",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/faith-and-Grace-life-story-base.jpg')"
    image: null,
    paperBg: "#faf7f2",
  },
  {
    ...
    icon: "🎖️",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/military-honor-life-story-base.jpg')",
    image: null,
    paperBg: "#f4f7fa",
  },
  {
    ...
    label: "Garden & Nature",
    icon: "🌿",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/garden-nature-life-story-base.jpg')",
    image: null,
    paperBg: "#f4faf2",
  },
  {
    ...
    label: "Elegant Linen",
    icon: "🕊️",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/elegant-linen-life-story-base.jpg')",
    image: null,
    paperBg: "#faf9f7",
  },
  {
    ...
    label: "Golden Sunset",
    icon: "🌅",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/golden-sunset-life-story-base.jpg')",
    image: null,
    paperBg: "#fdf8f0",
  },
  {
    ...
    icon: "📜",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/vintage-script-life-story-base.jpg')",
    image: null,
    paperBg: "#faf7ef",
  },
  {
    ...
    label: "Candlelight",
    icon: "🕯️",
    css: "url('https://4everafter.cloud/wp-content/uploads/2026/base-options/candles-life-story-base.jpg')",
    image: null,
    paperBg: "#fdfaf4",
  },
];
  ...
  return (
    <div style={{ textAlign: "center", padding: "36px 20px 20px" }}>
      <div style={{
        ...
        background: "radial-gradient(ellipse at center, #3a2800 0%, #1a1200 60%, #0d0900 100%)",
        borderRadius: 20, padding: "28px 44px",
        boxShadow: "0 0 60px rgba(201,148,26,0.4), 0 0 120px rgba(201,148,26,0.15), inset 0 1px 0 rgba(245,200,66,0.2)",
        ...
        <div style={{
          ...
          filter: "drop-shadow(0 0 20px rgba(245,200,66,0.5))", letterSpacing: "-1px", lineHeight: 1,
        }}>
          4EverAfter
          <span style={{ fontSize: "0.3em", verticalAlign: "super", WebkitTextFillColor: GOLD_LIGHT, filter: "none" }}>™</span>
        </div>
        <div style={{ fontFamily: "'Dancing Script', cursive", fontSize: "clamp(11px, 2.2vw, 17px)", color: GOLD_LIGHT, marginTop: 8, opacity: 0.9 }}>
          "Turning Farewells Into Meaningful Memories"
        </div>
      </div>
    </div>
  );
        ...
        {backgrounds.map(bg => (
          ...
          >
            ...
            <div style={{
              ...
              background: value === bg.id ? "rgba(0,0,0,0.1)" : "rgba(0,0,0,0.0)",
              display: "flex", flexDirection: "column",
              alignItems: "center", justifyContent: "center",
              transition: "background 0.2s",
            }}>
              <span style={{ fontSize: 20, lineHeight: 1, marginBottom: 3 }}>{bg.icon}</span>
              <span style={{
                fontSize: 9, fontFamily: "'Playfair Display', serif", fontWeight: 600,
                color: "#3a2800", letterSpacing: "0.2px", textAlign: "center",
